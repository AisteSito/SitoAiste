document.addEventListener("DOMContentLoaded", () => {
  ...
  // Загружаем JSON
  fetch("/script/appart.json") // путь к твоему JSON файлу
    .then((res) => res.json())
    .then((data) => {
      ...
      <div class="property-content">
        ...
        <div class="prop-down-sec">
          ...
          <div class="property-buttons">
            <a class="btn-main" href="/property/?src=appart&slug=${prop.slug}">Plačiau</a>
            <a class="btn-icon" href="/property?slug=${prop.slug}">&#8594;</a>
          </div>
        </div>
      </div>
    `;
